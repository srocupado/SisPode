...
{"ferramenta": "<nome>", "argumentos": {"pergunta": "<p/ perguntar, listar_documentos ou votacao: o pedido, preservando siglas (PL 1234/2026) e datas (dd/mm/aaaa)>", "texto": "<apenas p/ responder: sua resposta curta em pt-BR>"}}
...
async function rotear(perfil, mensagem) {
  ...
  const validas = ['verificar_pauta', 'escolher_pauta', 'importar_pauta', 'ordem_do_dia', 'listar_itens', 'ver_nota', 'perguntar', 'listar_documentos', 'votacao', 'analisar', 'exportar', 'ajuda', 'responder'];
