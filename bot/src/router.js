...
- "digest": radar de IMPRENSA (Fantástico, Jornal Nacional, Profissão Repórter, Globo Rural, Agência Brasil) — resume os temas e avalia a relevância para ações legislativas (PL, requerimentos, CPI), com minuta em PDF sob demanda. Use para "o que deu no fantástico?", "radar do fantástico", "resumo do programa de domingo", "temas do fantástico para projetos".
