...
- "questao_ordem" {"termo":"ata de comissão"}: busca no acervo COMPLETO de questões de ordem do Plenário (1953 até hoje). Cada QO é indexada em todas as suas fases: a questão levantada, a CONTRADITA, a DECISÃO da Presidência, o RECURSO contra ela e os artigos do Regimento invocados. Use para "houve questão de ordem sobre X?", "como a Presidência decidiu sobre Y?", "houve recurso contra decisão sobre Z?", "questões de ordem do deputado Fulano". Aceita três formas de termo: TEMA ("avocação de decisão"), NÚMERO EXATO ("8/2023" — mande só o número, sem mais palavras) e ARTIGO ("art. 52", traz as QOs que invocaram aquele dispositivo). É o PRECEDENTE — como a Presidência já decidiu na prática. Numa dúvida regimental relevante, vale consultar "regimento" (a norma) E "questao_ordem" (o precedente). A observação traz a decisão junto (linha ⚖️): REPRODUZA-A, é ela que responde "e no que deu?".
