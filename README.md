...
- **Sustentação do posicionamento** (opcional): um campo pergunta se a matéria exige defesa — **favorável** ou **contrária** — e um campo livre recebe o ponto a enfatizar. O provedor de IA rascunha a argumentação a partir dos documentos e do voto registrado, em **campo editável**: o analista revisa, e o que sai no PDF é o texto dele. A seção é própria, depois do registro de votos, e o documento declara que é texto argumentativo e se houve revisão humana
