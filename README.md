...
- **Resumo de cada item** (opcional, na consulta por proposição): vai ao **inteiro teor** dos documentos e traz o que o destaque pedia e a **justificação da emenda destacada**, mais a indexação da Câmara e a justificação do autor do projeto. Tudo é **transcrição literal**, com link para a fonte — nada é gerado nem resumido por modelo, e documento sem justificação sai sem resumo em vez de ganhar um inventado
